...
The `useTracker` hook provides access to tracking functionality and context management within your components.
...
Here's a complete example showing how to use the `useTracker` hook:
